        ...
        e(window)
          .resize(function() {
            ...
            n.r = setTimeout(function() {
              var e = { height: o.eq(n.i).outerHeight() },
                r = t.outerWidth();
              s.css(e);
              e['width'] =
                Math.min(Math.round(r / t.parent().width() * 100), 100) + '%';
              t.css(e);
            }, 50);
          })
          .resize();
    ...
    n.to = function(r, i) {
      ...
      if (!u.queue('fx').length) {
        o
          ...
          .removeClass('active');
        o.animate(d, h, p) &&
          u.animate(e.extend({ left: '-' + r + '00%' }, d), h, p, function(t) {
            n.i = r;
